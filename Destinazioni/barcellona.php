...
<body>
    ...
    <div class="row" style="position: relative;">
            <img src="https://www.barcellona.org/wp-content/uploads/sites/14/barcellona.jpg" alt="imm" class="img-fluid fadein" id="dest-img">
            <h1 id="img-caption" data-aos="fade-up" data-aos-duration="800" data-aos-offset="200">Barcellona</h1>
        </div>
        <div class="row justify-content-center p-3" data-aos="fade-down" data-aos-offset="50" data-aos-duration="1500" style="background-color: rgba(233, 236, 239, 1);">
                    ...
                    if(!isset($_SESSION['nome'])){
                        ...
                        <select size=1 name=\"fascia_età\" class=\"form-select mb-3\">
                            ...
                            <select size=1 name=\"durata\" class=\"form-select mb-3\">
                                ...
                                <option value=\"Due settimana\">Due settimane</option>
